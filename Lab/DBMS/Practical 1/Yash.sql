...
CREATE TABLE REGION(
	...
	REGION_DESC VARCHAR(10) NOT NULL,
	CONSTRAINT REGION_PK_CODE PRIMARY KEY (REGION_CODE),
	CONSTRAINT REGION_CK_DESC CHECK (REGION_DESC IN ('East', 'West', 'North', 'South'))
);
...
CREATE TABLE EMP(
	...
	CONSTRAINT EMP_CK_SALARY CHECK (SALARY>=10000),
	CONSTRAINT EMP_PK_EMPCODE PRIMARY KEY(EMP_CODE) 
);
...
CREATE TABLE STORE(
	...
	REGION_CODE NUMBER(1) NOT NULL,
	EMP_CODE NUMBER(2),
	CONSTRAINT STORE_PK_SCODE PRIMARY KEY (STORE_CODE),
	CONSTRAINT STORE_FK_RCODE FOREIGN KEY(REGION_CODE) REFERENCES REGION(REGION_CODE),
	CONSTRAINT STORE_FK_ECODE FOREIGN KEY(EMP_CODE) REFERENCES EMP(EMP_CODE)
);
...
ALTER TABLE EMP 
ADD CONSTRAINT EMP_FK_SCODE 
FOREIGN KEY(STORE_CODE) REFERENCES STORE(STORE_CODE);


INSERT INTO EMP VALUES(12, 'Yash', 'Wankhedkar', TO_DATE('2002-05-10','yyyy-mm-dd'), 41, 36000);
...
INSERT INTO EMP VALUES(18, 'Rubal', 'Singh', TO_DATE('2002-04-11','yyyy-mm-dd'), 31, 38000);
...
SELECT STORE.STORE_CODE, STORE.STORE_NAME, REGION.REGION_DESC FROM STORE JOIN REGION USING(REGION_CODE);